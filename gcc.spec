...
Source0: https://github.com/NewsCentOS7/gcc/releases/download/download/gcc-%{version}-%{DATE}.tar.xz
Source1: https://github.com/NewsCentOS7/gcc/releases/download/download/isl-%{isl_version}.tar.bz2
Source2: https://github.com/NewsCentOS7/gcc/releases/download/download/mpc-%{mpc_version}.tar.gz
Source3: https://github.com/NewsCentOS7/gcc/releases/download/download/doxygen-%{doxygen_version}.src.tar.gz
...
BuildRequires: glibc glibc-devel glibc-i686
%endif
%ifarch ia64
...
Patch18: gcc8-rh1760208-1.patch
Patch19: gcc8-rh1760208-2.patch
Patch20: gcc8-rh1760208-3.patch
Patch21: gcc8-rh1760208-4.patch
...
%changelog
* Tue Feb  4 2020 Marek Polacek <polacek@redhat.com> 8.3.1-3.2
...
* Tue Feb  5 2019 Marek Polacek <polacek@redhat.com> 8.2.1-7.1
- add liblsan_preinit.o (#1667885)

* Wed Jan  9 2019 Marek Polacek <polacek@redhat.com> 8.2.1-7
...
* Tue Sep 11 2018 Jeff Law <law@redhat.com> 8.2.1-3
- Sync legacy fortran support (#1625506)

* Wed Sep  5 2018 Marek Polacek <polacek@redhat.com> 8.2.1-3
- update from Fedora gcc-8.2.1-3

* Wed Sep  5 2018 Jeff Law <law@redhat.com> 8.2.1-2.3
- Sync legacy fortran support (#1625506)

* Wed Aug 15 2018 Marek Polacek <polacek@redhat.com> 8.2.1-2.2
- add gcov-dump (#1616277)

* Tue Aug 14 2018 Jeff Law <law@redhat.com> 8.2.1-2.1
- Fix codegen issue with EQUIVALENCE/AUTOMATIC

* Fri Jul 27 2018 Marek Polacek <polacek@redhat.com> 8.2.1-2
- update from Fedora gcc-8.2.1-2

* Fri Jul 27 2018 Marek Polacek <polacek@redhat.com> 8.2.1-1.1
- add missing headers (#1611637)

* Fri Jul 27 2018 Marek Polacek <polacek@redhat.com> 8.2.1-1
- update from Fedora gcc-8.2.1-1
